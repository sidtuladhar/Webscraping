...
with open("stock.csv", 'w', encoding='utf8', newline='') as x:
    writer = writer(x)
    header = ['Date', 'Company Name', 'Number of Transactions', 'Max Price', 'Min Price', 'Closing Price',
              'Traded Shares', 'Amount', 'Previous Closing', 'Difference Rs.']
    ...
    try:
        ...
        for i in range(3, 500):
            ...
            info = [date, company_name, no_of_transactions, max_price, min_price, close_price, traded_shares, amount,
                    prev_close, diff]
